...
public class FirstGameTipView extends Group implements IFirstGameTipView, InputProcessor {

    private TextureAtlas firstGameTipAtlas;
    private FirstGameTipPresenter presenter;

    public FirstGameTipView(FirstGameTipPresenter presenter, TextureAtlas firstGameTipAtlas){
        this.presenter = presenter;
        this.firstGameTipAtlas = firstGameTipAtlas;
    }

    @Override
    public void showTutorialScreen(ImageButton button, String tutorialScreenName){

        Image screen = new Image(firstGameTipAtlas.findRegion(tutorialScreenName));
