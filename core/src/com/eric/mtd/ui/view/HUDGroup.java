...
import com.eric.mtd.ui.view.widget.*;
public class HUDGroup extends Group implements IUIStateObserver, ILevelStateObserver{
	...
	public HUDGroup(UIStateManager uiStateManager,LevelStateManager levelStateManager,IHUDController controller){
