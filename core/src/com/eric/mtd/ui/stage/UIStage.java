...
import com.eric.mtd.ui.controller.GameOverController;
...
import com.eric.mtd.ui.view.GameOverGroup;
...
public class UIStage extends Stage implements IUIStateObserver{
	...
	public UIStage(int intLevel, Player player, ActorGroups actorGroups, UIStateManager uiStateManager, 
