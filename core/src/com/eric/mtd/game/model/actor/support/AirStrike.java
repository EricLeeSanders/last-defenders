...
public class AirStrike extends SupportActor implements IAoe{
	...
	public static final Vector2 BULLET_SIZE = new Vector2(20,20);
	...
	public AirStrike(Pool<SupportActor> pool, TextureRegion textureRegion) {
		super(pool, textureRegion, new Vector2(textureRegion.getRegionWidth(), textureRegion.getRegionHeight())
	...
	public void beginAirStrike(){
		...
		this.addAction(Actions.moveTo(Resources.VIRTUAL_WIDTH+this.getHeight(), ((Resources.VIRTUAL_HEIGHT/2) - (getHeight()/2)),  2.5f, Interpolation.linear));
		System.out.println("location size : " + airStrikeLocations.size);
	...
	private void dropBomb(AirStrikeLocation location){
		...
		bomb.initialize(this, location.getLocation(), this.getEnemyGroup(),this.getGunPos(), BULLET_SIZE); 
