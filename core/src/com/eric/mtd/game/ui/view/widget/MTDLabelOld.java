...
public class MTDLabelOld extends Label {

	public MTDLabelOld(String layer, String objectName, String text, boolean visible, Color fontColor, int align, BitmapFont font) {
