...
public class EnemyHumvee extends Enemy implements IVehicle, IPassiveEnemy {
	...
	public EnemyHumvee(TextureRegion[] actorRegions, CombatActorPool<CombatActor> pool, IDeathEffectFactory deathEffectFactory) {
		super(actorRegions, pool, null, TEXTURE_SIZE, GUN_POS, SPEED, HEALTH, ARMOR, ATTACK, ATTACK_SPEED, RANGE);
